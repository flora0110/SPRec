...
do
    ...
    do
        ...
        dpo_train_data_path="${it_output_dir}/data/"
        ...
        CUDA_VISIBLE_DEVICES=$gpu1 python ./train/select_reject_base_sim.py \
            --train_json_file "$sft_train_data_path" \
            --similarity_chunk_dir "./models/Random50_Similarity/Goodreads/" \
            --output_dir "$dpo_train_data_path" \
